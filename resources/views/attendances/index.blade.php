...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6 bg-white border-b border-gray-200">
        ...
        <!-- Filters -->
        <form action="{{ route('attendance.index') }}" method="GET" class="mb-6 bg-gray-50 p-4 rounded-lg">
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">
                                    {{ $attendance->member->last_name }}, {{ $attendance->member->first_name }}
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="text-sm text-gray-500">
                                    {{ $attendance->service->service_date->format('M d, Y') }}
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                {{ $attendance->duration_in_minutes ?? '-' }} min
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('attendance.edit', $attendance) }}" class="text-blue-600 hover:text-blue-900 mr-3">Edit</a>
