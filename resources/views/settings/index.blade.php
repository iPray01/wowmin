                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input type="checkbox" name="notifications[sms]" id="notifications_sms"
                                           class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                           {{ $settings['notifications']['sms'] ? 'checked' : '' }}>
                                </div>
                                <div class="ml-3 text-sm">
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input type="checkbox" name="notifications[browser]" id="notifications_browser"
                                           class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                           {{ $settings['notifications']['browser'] ? 'checked' : '' }}>
                                </div>
                                <div class="ml-3 text-sm">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select name="display[language]" id="display_language"
                                        class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                                    <option value="en" {{ $settings['display']['language'] === 'en' ? 'selected' : '' }}>English</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select name="privacy[profile_visibility]" id="privacy_profile_visibility"
                                        class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                                    <option value="public" {{ $settings['privacy']['profile_visibility'] === 'public' ? 'selected' : '' }}>Public</option>
                                    <option value="members" {{ $settings['privacy']['profile_visibility'] === 'members' ? 'selected' : '' }}>Members Only</option>
                                    <option value="private" {{ $settings['privacy']['profile_visibility'] === 'private' ? 'selected' : '' }}>Private</option>
                                </select>
                            </div>
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input type="checkbox" name="privacy[show_online_status]" id="privacy_show_online_status"
                                           class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                           {{ $settings['privacy']['show_online_status'] ? 'checked' : '' }}>
                                </div>
                                <div class="ml-3 text-sm">
