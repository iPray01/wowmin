        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('sms.messages.store') }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="content" id="content" rows="4"
                                      ...
                                      required
                                      onkeyup="updateMessageStats(this.value)">{{ old('content') }}</textarea>
                                    ...
                                    <div class="border rounded-md p-4">
                                        <div class="mb-2">
                                            <textarea name="manual_numbers" id="manual_numbers" rows="3"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                                placeholder="Enter phone numbers, one per line. Format: +1234567890">{{ old('manual_numbers') }}</textarea>
