        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('sms-groups.update', $group) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Manage Members</label>
                                ...
                                @foreach($members as $member)
                                    <div class="flex items-center mb-2">
                                        <input type="checkbox" name="members[]" value="{{ $member->id }}"
                                               ...
                                               {{ in_array($member->id, old('members', $group->members->pluck('id')->toArray())) ? 'checked' : '' }}>
