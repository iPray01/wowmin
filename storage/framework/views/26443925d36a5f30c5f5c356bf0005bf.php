            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <section>
                        ...
                        <form method="post" action="<?php echo e(route('profile.password.update')); ?>" class="mt-6 space-y-6">
                            <?php echo csrf_field(); ?>
...
<?php endif; ?> <?php /**PATH C:\xampp\htdocs\wowmin\resources\views\profile\edit.blade.php ENDPATH**/ ?>