...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <form action="<?php echo e(route('members.update', $member)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="first_name" id="first_name" value="<?php echo e(old('first_name', $member->first_name)); ?>" 
                        ...
                        <div>
                            ...
                            <input type="text" name="last_name" id="last_name" value="<?php echo e(old('last_name', $member->last_name)); ?>" 
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal focus:ring focus:ring-teal focus:ring-opacity-50">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="tel" name="phone" id="phone" value="<?php echo e(old('phone', $member->phone)); ?>" 
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal focus:ring focus:ring-teal focus:ring-opacity-50">
                        </div>

                        <div>
                            <label for="date_of_birth" class="block text-sm font-medium text-gray-700">Date of Birth</label>
                            <input type="date" name="date_of_birth" id="date_of_birth" value="<?php echo e(old('date_of_birth', $member->date_of_birth ? $member->date_of_birth->format('Y-m-d') : '')); ?>" 
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal focus:ring focus:ring-teal focus:ring-opacity-50">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="marital_status" id="marital_status" 
                                ...
                                <option value="single" <?php echo e(old('marital_status', $member->marital_status) === 'single' ? 'selected' : ''); ?>>Single</option>
                                <option value="married" <?php echo e(old('marital_status', $member->marital_status) === 'married' ? 'selected' : ''); ?>>Married</option>
                                <option value="divorced" <?php echo e(old('marital_status', $member->marital_status) === 'divorced' ? 'selected' : ''); ?>>Divorced</option>
                                <option value="widowed" <?php echo e(old('marital_status', $member->marital_status) === 'widowed' ? 'selected' : ''); ?>>Widowed</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="membership_status" id="membership_status" 
                                ...
                                <?php $__currentLoopData = $membershipStatusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value); ?>" <?php echo e(old('membership_status', $member->membership_status) === $value ? 'selected' : ''); ?>>
                                        <?php echo e($label); ?>
                        ...
                        <div>
                            ...
                            <input type="date" name="membership_date" id="membership_date" value="<?php echo e(old('membership_date', $member->membership_date ? $member->membership_date->format('Y-m-d') : '')); ?>" 
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal focus:ring focus:ring-teal focus:ring-opacity-50">
                        </div>

                        <div>
                            <label for="baptism_date" class="block text-sm font-medium text-gray-700">Baptism Date</label>
                            <input type="date" name="baptism_date" id="baptism_date" value="<?php echo e(old('baptism_date', $member->baptism_date ? $member->baptism_date->format('Y-m-d') : '')); ?>" 
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal focus:ring focus:ring-teal focus:ring-opacity-50">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="family_id" id="family_id" 
                                ...
                                <?php $__currentLoopData = $families; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $family): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($family->id); ?>" <?php echo e(in_array($family->id, $memberFamilies) ? 'selected' : ''); ?>>
                        ...
                        <div class="flex items-center mt-4">
                            <input type="checkbox" name="is_active" id="is_active" <?php echo e(old('is_active', $member->is_active) ? 'checked' : ''); ?> 
                    ...
                    <div class="space-y-4 md:col-span-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" name="emergency_contact_name" id="emergency_contact_name" value="<?php echo e(old('emergency_contact_name', $member->emergency_contact_name)); ?>" 
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal focus:ring focus:ring-teal focus:ring-opacity-50">
                            </div>

                            <div>
                                <label for="emergency_contact_phone" class="block text-sm font-medium text-gray-700">Contact Phone</label>
                                <input type="tel" name="emergency_contact_phone" id="emergency_contact_phone" value="<?php echo e(old('emergency_contact_phone', $member->emergency_contact_phone)); ?>" 
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal focus:ring focus:ring-teal focus:ring-opacity-50">
                            </div>

                            <div>
                                <label for="emergency_contact_relationship" class="block text-sm font-medium text-gray-700">Relationship</label>
                                <input type="text" name="emergency_contact_relationship" id="emergency_contact_relationship" value="<?php echo e(old('emergency_contact_relationship', $member->emergency_contact_relationship)); ?>" 
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal focus:ring focus:ring-teal focus:ring-opacity-50">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        <div>
                            ...
                            <textarea name="address" id="address" rows="3" 
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal focus:ring focus:ring-teal focus:ring-opacity-50"><?php echo e(old('address', $member->address)); ?></textarea>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wowmin\resources\views\members\edit.blade.php ENDPATH**/ ?>