        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="<?php echo e(route('finance.donations.create')); ?>" 
                ...
                <div class="bg-gray-50 p-4 rounded-lg mb-6">
                    <form action="<?php echo e(route('finance.donations.index')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                        ...
                        <div class="md:col-span-3 flex justify-end space-x-2">
                            ...
                            <a href="<?php echo e(route('finance.donations.index')); ?>" 
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $donations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $donation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <?php echo e($donation->donation_date->format('Y-m-d')); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <?php else: ?>
                                            <a href="<?php echo e(route('members.show', $donation->member)); ?>" 
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="text-gray-900 font-medium">
                                            GH₵ <?php echo e(number_format($donation->amount, 2)); ?>

                                        </span>
                                        <?php if($donation->gift_aid_amount): ?>
                                            <span class="text-teal text-sm ml-1">
                                                +<?php echo e(number_format($donation->gift_aid_amount, 2)); ?> Gift Aid
                                            </span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if($donation->campaign): ?>
                                            <a href="<?php echo e(route('finance.campaigns.show', $donation->campaign)); ?>"
                                               class="text-teal hover:text-teal-dark">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php echo e($paymentMethods[$donation->payment_method] ?? $donation->payment_method); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                            <?php if($donation->payment_status === 'completed'): ?> bg-green-100 text-green-800
                                            <?php elseif($donation->payment_status === 'pending'): ?> bg-yellow-100 text-yellow-800
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wowmin\resources\views\finance\donations\index.blade.php ENDPATH**/ ?>