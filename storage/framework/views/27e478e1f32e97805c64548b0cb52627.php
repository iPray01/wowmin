...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6 bg-white border-b border-gray-200">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="<?php echo e(route('finance.donations.create')); ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                Record Donation
            </a>
        </div>

        <!-- Filters -->
        <form action="<?php echo e(route('finance.donations.index')); ?>" method="GET" class="mb-6 bg-gray-50 p-4 rounded-lg">
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">
                                    <?php echo e($donation->member->last_name); ?>, <?php echo e($donation->member->first_name); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <?php if($donation->is_recurring): ?>
                                    <div class="text-xs text-blue-600">
                                        Recurring (<?php echo e(ucfirst($donation->recurring_frequency)); ?>)
                                    </div>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="text-xs text-gray-500">
                                    <?php echo e($donation->donation_date->format('h:i A')); ?>

                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    <?php echo e($donation->campaign ? $donation->campaign->name : 'General Fund'); ?>

                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    <?php echo e($paymentMethods[$donation->payment_method]); ?>

                                </div>
                                <?php if($donation->transaction_id): ?>
                                    <div class="text-xs text-gray-500">
                                        ID: <?php echo e($donation->transaction_id); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="<?php echo e(route('finance.donations.show', $donation)); ?>" class="text-blue-600 hover:text-blue-900 mr-3">View</a>
                                <a href="<?php echo e(route('finance.donations.edit', $donation)); ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wowmin\resources\views\donations\index.blade.php ENDPATH**/ ?>