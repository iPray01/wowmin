...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="card">
        ...
        <form action="<?php echo e(route('attendance.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="event_date" id="event_date" class="form-input" required value="<?php echo e(date('Y-m-d')); ?>">
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wowmin\resources\views\attendance\create.blade.php ENDPATH**/ ?>