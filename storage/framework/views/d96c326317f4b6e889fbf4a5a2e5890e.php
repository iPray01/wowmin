            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="<?php echo e(route('messages.store')); ?>" method="POST">
                        ...
                        <?php if(isset($replyToThread)): ?>
                            <input type="hidden" name="thread_id" value="<?php echo e($replyToThread->id); ?>">
                        <?php endif; ?>
                            ...
                            <div class="mb-6">
                                ...
                                <select name="recipient_ids[]" id="recipient_ids" multiple
                                    ...
                                    <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($member->id); ?>" <?php echo e(in_array($member->id, old('recipient_ids', [])) ? 'selected' : ''); ?>>
                                            <?php echo e($member->full_name); ?>

                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['recipient_ids'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?> <?php /**PATH C:\xampp\htdocs\wowmin\resources\views\messages\create.blade.php ENDPATH**/ ?>