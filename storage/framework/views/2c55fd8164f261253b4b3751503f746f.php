...
<div class="bg-white py-8 px-6 shadow-xl rounded-lg sm:px-10">
    ...
    <form class="space-y-6" method="POST" action="<?php echo e(route('password.update')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div>
            ...
            <div class="mt-1">
                <input id="email" name="email" type="email" autocomplete="email" required
                    ...
                    value="<?php echo e($email ?? old('email')); ?>" placeholder="Enter your email">
            </div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wowmin\resources\views\auth\passwords\reset.blade.php ENDPATH**/ ?>