...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 md:p-8">
            ...
            <form action="<?php echo e(route('finance.campaigns.store')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" required
                        ...
                        value="<?php echo e(old('name')); ?>" placeholder="e.g., Building Fund 2024">
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4" required
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500"
                        placeholder="Describe the purpose and goals of this campaign"><?php echo e(old('description')); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input type="number" name="target_amount" id="target_amount" required step="0.01" min="0"
                            ...
                            value="<?php echo e(old('target_amount')); ?>" placeholder="0.00">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wowmin\resources\views\finance\campaigns\create.blade.php ENDPATH**/ ?>