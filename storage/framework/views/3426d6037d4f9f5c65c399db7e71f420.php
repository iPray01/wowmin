<?php $__env->startSection('title', 'Record Tithe'); ?>
...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="card">
        ...
        <form action="<?php echo e(route('finance.tithe.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <select name="member_id" id="member_id" class="form-input" required>
                            ...
                            <?php $__currentLoopData = $members ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($member->id); ?>" data-income="<?php echo e($member->monthly_income ?? 0); ?>">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="preferred_day" id="preferred_day" class="form-input">
                            <?php for($i = 1; $i <= 28; $i++): ?>
                                <option value="<?php echo e($i); ?>"><?php echo e($i); ?><?php echo e($i == 1 ? 'st' : ($i == 2 ? 'nd' : ($i == 3 ? 'rd' : 'th'))); ?></option>
                            <?php endfor; ?>
                        </select>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wowmin\resources\views\finance\tithe\create.blade.php ENDPATH**/ ?>