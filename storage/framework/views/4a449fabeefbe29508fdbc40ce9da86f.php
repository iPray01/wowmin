<?php $__env->startSection('title', 'Record New Donation'); ?>
...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="bg-white shadow-sm rounded-lg">
        <div class="p-6">
            ...
            <form action="<?php echo e(route('finance.donations.store')); ?>" method="POST" id="donationForm" class="space-y-8">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label for="is_anonymous" class="flex items-center">
                                <input type="checkbox" name="is_anonymous" id="is_anonymous" class="form-checkbox rounded text-blue-600" value="1" <?php echo e(old('is_anonymous') ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="donation_type" id="donation_type" class="form-select block w-full" required>
                                ...
                                <option value="tithe" <?php echo e(old('donation_type') == 'tithe' ? 'selected' : ''); ?>>Tithe</option>
                                <option value="offering" <?php echo e(old('donation_type') == 'offering' ? 'selected' : ''); ?>>Offering</option>
                                <option value="special_offering" <?php echo e(old('donation_type') == 'special_offering' ? 'selected' : ''); ?>>Special Offering</option>
                                <option value="building_fund" <?php echo e(old('donation_type') == 'building_fund' ? 'selected' : ''); ?>>Building Fund</option>
                                <option value="missions" <?php echo e(old('donation_type') == 'missions' ? 'selected' : ''); ?>>Missions</option>
                                <option value="other" <?php echo e(old('donation_type') == 'other' ? 'selected' : ''); ?>>Other</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="date" name="donation_date" id="donation_date" 
                                ...
                                value="<?php echo e(old('donation_date', date('Y-m-d'))); ?>">
                        ...
                        <div>
                            ...
                            <select name="payment_method" id="payment_method" class="form-select block w-full" required>
                                <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value); ?>" <?php echo e(old('payment_method') == $value ? 'selected' : ''); ?>>
                                        <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    ...
                    <div id="recurring_details" class="grid grid-cols-1 md:grid-cols-3 gap-6 <?php echo e(old('is_recurring') ? '' : 'hidden'); ?>">
                        <div>
                        ...
                        <div>
                            ...
                            <input type="date" name="recurring_start_date" id="recurring_start_date" 
                                class="form-input block w-full"
                                value="<?php echo e(old('recurring_start_date', date('Y-m-d'))); ?>">
                        </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="notes" id="notes" rows="3" 
                                ...
                                placeholder="Add any additional notes about this donation"><?php echo e(old('notes')); ?></textarea>
                        </div>

                        <div class="flex items-center">
                            <input type="checkbox" name="send_receipt" id="send_receipt" 
                                class="form-checkbox rounded text-blue-600" value="1"
                                <?php echo e(old('send_receipt') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wowmin\resources\views\finance\donations\create.blade.php ENDPATH**/ ?>