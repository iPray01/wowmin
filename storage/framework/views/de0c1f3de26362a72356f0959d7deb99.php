        ...
        <div class="mx-auto max-w-7xl">
            <div class="relative shadow-xl sm:overflow-hidden rounded-2xl">
                <div class="absolute inset-0">
                    <img class="h-full w-full object-cover" src="<?php echo e(asset('storage/images/logob.jpeg')); ?>" alt="">
        ...
        <div class="max-w-7xl mx-auto py-12 px-6 md:flex md:items-center md:justify-between lg:px-8">
            ...
            <div class="mt-8 md:mt-0 md:order-1">
                <p class="text-center text-base text-gray-400">
                    &copy; <?php echo e(date('Y')); ?> WoW Ministry Int'l. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
</body>
</html><?php /**PATH C:\xampp\htdocs\wowmin\resources\views\welcome.blade.php ENDPATH**/ ?>