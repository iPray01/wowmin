...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Edit SMS Message')); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="<?php echo e(route('sms.messages.update', $message)); ?>">
                        <?php echo csrf_field(); ?>
                                ...
                                <select name="template_id" id="template_id" 
                                    ...
                                    <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($template->id); ?>" 
                                                ...
                                                <?php echo e(old('template_id', $message->template_id) == $template->id ? 'selected' : ''); ?>>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="content" id="content" rows="4"
                                      ...
                                      required
                                      onkeyup="updateMessageStats(this.value)"><?php echo e(old('content', $message->content)); ?></textarea>
                                    ...
                                    <div class="border rounded-md p-4">
                                        <div class="mb-2">
                                            <textarea name="manual_numbers" id="manual_numbers" rows="3"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                                placeholder="Enter phone numbers, one per line. Format: +1234567890"><?php echo e(old('manual_numbers', $message->recipients->whereNull('member_id')->pluck('phone_number')->implode("\n"))); ?></textarea>
                                        ...
                                        <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="flex items-center mb-2">
                                                <input type="checkbox" name="groups[]" value="<?php echo e($group->id); ?>"
                                                       ...
                                                       <?php echo e(in_array($group->id, old('groups', [$message->group_id])) ? 'checked' : ''); ?>>
                                        ...
                                        <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="flex items-center mb-2">
                                                <input type="checkbox" name="members[]" value="<?php echo e($member->id); ?>"
                                                       class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                                       <?php echo e(in_array($member->id, old('members', $message->recipients->whereNotNull('member_id')->pluck('member_id')->toArray())) ? 'checked' : ''); ?>>
                                                <label class="ml-2 text-sm text-gray-700">
                            ...
                            <div class="space-y-4">
                                <div>
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="send_time" value="now" class="form-radio"
                                               <?php echo e(!$message->scheduled_at ? 'checked' : ''); ?>
                                ...
                                <div>
                                    ...
                                    <input type="datetime-local" name="scheduled_at" id="scheduled_at"
                                           ...
                                           value="<?php echo e(old('scheduled_at', $message->scheduled_at ? $message->scheduled_at->format('Y-m-d\TH:i') : '')); ?>"
                                           <?php echo e(!$message->scheduled_at ? 'disabled' : ''); ?>>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="<?php echo e(route('sms.messages.show', $message)); ?>" 
...
<?php endif; ?> <?php /**PATH C:\xampp\htdocs\wowmin\resources\views\sms\messages\edit.blade.php ENDPATH**/ ?>